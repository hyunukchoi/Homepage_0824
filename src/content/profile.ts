...
export const about = {
  ...
  body: "다양한 상용 엔진과 라이브 서비스를 거치며 모듈화와 코드 안정성의 중요성을 배웠습니다. 컴포넌트 단위로 구조를 탄탄히 짜고, AI 도구를 활용하더라도 모든 코드는 직접 디버깅하며 완성합니다.",
};
...
export const capabilities: Capability[] = [
  {
    ...
    body: "PC 온라인 라이브 서비스 경험을 바탕으로, 언리얼과 유니티를 활용해 요구사항에 최적화된 VR 콘텐츠와 모듈형 아키텍처를 구축합니다.",
  },
  {
    id: "ux",
    index: "02",
    ...
    body: "전담 기획자가 없는 환경에서도 훈련 단계를 세분화하고, 이동 멀미 저감 알고리즘과 핸드 트래킹 조작계를 직접 구현합니다.",
  },
  {
    id: "hardware",
    index: "03",
    ...
    body: "모션 시뮬레이터, VR 트레드밀, 햅틱 슈트 SDK를 연동해 시각과 물리 감각이 일치하는 몰입감을 구현합니다.",
  },
  {
    id: "infrastructure",
    index: "04",
    ...
    body: "외부 인터넷이 없는 폐쇄망 환경의 자체 소켓 서버와, 수십 대 HMD를 원격 일괄 제어하고 모니터링하는 관제 시스템을 개발합니다.",
  },
  {
    id: "ai",
    index: "05",
    ...
    body: "AI 코드 파편화를 방지하기 위해 컴포넌트 단위로 역할을 쪼개어 개발하며, 모든 C++ 코드는 직접 디버깅해 검증합니다.",
  },
];
